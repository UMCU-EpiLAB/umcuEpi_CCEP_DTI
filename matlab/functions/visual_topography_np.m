function V = visual_topography_np(vector_v1, vector_v2, v1_soz, v1_nsoz, v2_soz, v2_nsoz,subj,i,j)
% INPUT:
...
xlim([round(min(vector_v1)/5)*5,round(max(vector_v1)/5)*5])
ylim([0,round(max(vector_v2)/5)*5])

set(gca, 'XTick',[round(min(vector_v1)/5)*5,round(((max(vector_v1)-min(vector_v1))/2+min(vector_v1))/5)*5,round(max(vector_v1)/5)*5])%numelxt
set(gca, 'XTickLabel',[round(min(vector_v1)/5)*5,round(((max(vector_v1)-min(vector_v1))/2+min(vector_v1))/5)*5,round(max(vector_v1)/5)*5])%numelxt

set(gca, 'YTick',[0,round(((max(vector_v2)-min(vector_v2))/2+min(vector_v2))/5)*5,round(max(vector_v2)/5)*5])%numelxt
set(gca, 'YTickLabel',[0,round(((max(vector_v2)-min(vector_v2))/2+min(vector_v2))/5)*5,round(max(vector_v2)/5)*5])%numelxt
