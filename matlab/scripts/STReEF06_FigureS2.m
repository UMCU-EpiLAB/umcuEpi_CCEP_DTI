...
saveas(NS,'correlation np effective grid','epsc') % save the figure for further processing with Adobe Illustrator
...
saveas(NS,'correlation np effective seeg 1','epsc') % save the figure for further processing with Adobe Illustrator
